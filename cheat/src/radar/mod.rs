...
pub static RADAR_LOCAL_LINK: std::sync::LazyLock<Arc<std::sync::Mutex<String>>> =
    std::sync::LazyLock::new(|| Arc::new(std::sync::Mutex::new(String::new())));

pub static RADAR_PUBLIC_LINK: std::sync::LazyLock<Arc<std::sync::Mutex<String>>> =
    std::sync::LazyLock::new(|| Arc::new(std::sync::Mutex::new(String::new())));
